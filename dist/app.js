...
var _user$project$View$footerView = A2(
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Your Site'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('pure-menu-item pure-menu-selected'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Tour'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {topic: a, gifUrl: b, topics: c};
	});
var _user$project$Main$NewTopic = function (a) {
	return {ctor: 'NewTopic', _0: a};
};
var _user$project$Main$selection = function (txt) {
	return A2(
		_elm_lang$html$Html$option,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$NewTopic(txt)),
				_1: {ctor: '[]'}
			}
		},
		{
		...
		switch (_p0.ctor) {
			...
			case 'NewGif':
				if (_p0._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A3(_user$project$Main$Model, model.topic, _p0._0._0, model.topics),
...
var _user$project$Main$bodyView = function (model) {
	var fn = A2(
		_elm_lang$core$List$map,
		function (x) {
			return _user$project$Main$selection(x);
		},
		model.topics);
	return A2(
		_elm_lang$html$Html$div,
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$bodyView(model),
				_1: {
					ctor: '::',
					_0: _user$project$View$footerView,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Main$init('dogs'),
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./marketing.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./marketing.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
